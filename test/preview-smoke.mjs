...
assert.match(html, /SayIt! \| Clearer conversations/i, "Preview should render the install title");
assert.match(html, /This page is the installer and setup guide/i, "Preview should render the installer shell");
